...
class Contact extends \Sulu\Bundle\ContactBundle\Entity\Contact implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'firstName', 'middleName', 'lastName', 'title', 'position', 'birthday', 'created', 'changed', 'locales', 'changer', 'creator', 'notes', 'emails', 'phones', 'faxes', 'formOfAddress', 'salutation', 'tags', 'account', 'addresses', 'accountContacts', 'newsletter', 'gender', 'mainEmail', 'mainPhone', 'mainFax', 'mainUrl', 'contactAddresses', 'medias', 'categories', 'urls', 'bankAccounts', 'avatar', 'apiBasePath', 'apiPath'];
        }
     ...
     * {@inheritDoc}
     */
    public function addTag(\Sulu\Bundle\TagBundle\Entity\Tag $tag)
    {
     ...
     * {@inheritDoc}
     */
    public function removeTag(\Sulu\Bundle\TagBundle\Entity\Tag $tag)
    {
